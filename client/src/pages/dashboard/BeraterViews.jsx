  ...
  return (
    <div className="broker-calendar">
      <div className="broker-calendar-nav">
        ...
        <button type="button" className="broker-calendar-nav-btn" onClick={() => shiftMonth(1)} aria-label="Nächster Monat">
      ...
      {savedDate && savedTime ? (
        <div className="broker-calendar-saved">
          ...
          <span>
            Rückruf geplant: <strong>{formatFollowUpDateTime(savedDate, savedTime)}</strong>
          </span>
        </div>
      ) : null}
      ...
      <div className="broker-detail-side-block broker-detail-report-block is-submitted">
        <div className={`broker-detail-report-done broker-detail-report-done--${report.status || 'in_pruefung'}`}>
          ...
          <div>
            ...
            <span>{formatDate(report.at)} · {reportReasonLabel(report.reasonId)}</span>
    ...
    return (
      <div className="broker-detail-side-block broker-detail-report-block">
        <div className="broker-report-closed">
          ...
          <span>
            Meldung war {LEAD_REPORT_WINDOW_DAYS} Tage nach Übergabe möglich
    ...
    <>
      <div className="broker-detail-side-block broker-detail-report-block">
        <button type="button" className="broker-report-trigger" onClick={() => setOpen(true)}>
          ...
          <span className="broker-report-trigger-copy">
            ...
            <small>
              Noch {windowInfo.daysLeft} {windowInfo.daysLeft === 1 ? 'Tag' : 'Tage'} · Storno oder Ersatz prüfen lassen
            </small>
          </span>
      ...
      {open ? (
        <div className="broker-modal broker-report-modal-wrap" role="dialog" aria-modal="true" aria-labelledby={`report-modal-title-${leadId}`}>
          <button type="button" className="broker-modal__backdrop" aria-label="Schließen" onClick={closeModal} />
          <form
            ref={panelRef}
              ...
              <div className="broker-report-modal__intro">
                ...
                {step === 1 ? (
                  <p className="broker-report-modal__hint">
                    Nur bei nachweisbaren Mängeln. Frist: noch {windowInfo.daysLeft}{' '}
              ...
              {step === 1 ? (
                <section className="broker-report-step">
                  <div className="broker-report-step__copy">
                    <h3>Grund wählen</h3>
                    <p>Doppelklick oder Auswahl + Weiter — akzeptierte Gründe laut Richtlinie</p>
                  </div>
                ...
                <section className="broker-report-step">
                  ...
                  <label className="broker-report-detail-field" htmlFor={`report-detail-${leadId}`}>
                    ...
                    <textarea
                      ...
                      placeholder="z. B. Nummer ist nicht vergeben, Anruf wird sofort beendet, Person kennt die Anfrage nicht …"
                      rows={6}
                      required
                  ...
                  <div className="broker-report-proof">
                    ...
                    <label className="broker-report-proof__btn" htmlFor={`report-proof-${leadId}`}>
                      ...
                      />
                      <Paperclip size={16} />
                      <span>{proofName || 'Datei anhängen'}</span>
                    </label>
                    {proofName ? (
                      <button
                        type="button"
    ...
    <div className="broker-page">
      <div className="broker-heading">
        <div>
          ...
          <p className="lede">Kanban per Drag &amp; Drop — oder klicken Sie einen Lead für alle Details.</p>
        </div>
      </div>
    ...
    <div className="broker-page">
      ...
      <div className="broker-detail-grid">
        <div className="broker-detail-sections">
          <DetailSection icon={User} title="Persönliche Daten">
            ...
            <DetailField label="PLZ / Ort">
              {lead.zip && lead.city ? `${lead.zip} ${lead.city}` : '—'}
            </DetailField>
          </DetailSection>
          ...
          <DetailSection icon={Shield} title="Versicherung">
            ...
            <DetailField label="Aktuelle Gesellschaft / Krankenkasse">{lead.insuranceCompany || '—'}</DetailField>
        ...
        <aside className="broker-detail-side-stack">
          <section className="broker-panel broker-detail-side">
            <div className="broker-detail-side-block">
              ...
              <p className="broker-detail-side-hint">Pipeline-Status für diesen Lead.</p>
              ...
              {status === 'wiedervorlage' ? (
                <div className={`broker-status-followup${followUp ? ' is-set' : ''}`}>
                  <p className="broker-status-followup-label">Rückruf planen</p>
                  <FollowUpCalendar
            ...
            <div className="broker-detail-side-block">
              <h2>Notizen</h2>
              <p className="broker-detail-side-hint">Eigene Notizen — nur für Sie sichtbar.</p>
              <textarea
                className="broker-detail-notes"
                value={notes}
                onChange={(event) => setNotes(event.target.value)}
                onBlur={saveNotes}
                placeholder="z. B. Rückruf vereinbart, offene Fragen, nächste Schritte…"
                rows={5}
              />
            </div>
          </section>
      ...
      <form className="broker-panel broker-settings broker-settings--wide" onSubmit={save}>
        ...
        <div className="broker-avatar-edit">
          ...
          <div>
            ...
            {!form.avatarUrl ? (
              <p className="broker-avatar-soft-hint">Optional — ein Foto macht Ihr Konto persönlicher.</p>
            ) : null}
